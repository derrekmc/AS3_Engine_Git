package particles2{
	...
	import Obj;
	public class Particlee extends Obj
	{	
		...
		public function Particlee(symbolclass:Class, target:DisplayObjectContainer, seed:Point, canCollide="NONE") 
		{
       ...
       // }
		...
		public function birth(seed){
			...
			// add gravity
			gravity = Global.randRange(-1.7, -2.5); 
			...
			clip.alpha = Global.randRange(0.9, 1); 
		...
		override public function boxBound(object:Object){			
