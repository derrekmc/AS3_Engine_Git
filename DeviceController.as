package {
	...
	public class InputController{		
		...
		var keyboardInUse	:Boolean = false;
		var MouseInUse		:Boolean = false;
				
		public function InputController(name:String="ui", filename:String="", offSetX:Number=0, offSetY:Number=0){
		...
		override public function useKeyboard(){
			trace("construct startScreen");			
		}
		
		override public function startMouse(){
			trace("construct startScreen");			
		}
