package {
	...
	public class Main extends MovieClip {
		...
		function Main(){
			...
			player = world.addPlayer("p1", path + "player.swf", 2000, -100, -20);
			Display.addWorld(world);
			...
			world.add(new Obj("health", path + "heart.png", "object"), true, 800, -380);
			//world.add(new Enemy("zombie", path + "enemy.swf"), true, 1120, -380);
			//world.add(new Enemy("zombie", path + "enemy.swf"), true, 820, -380);
			//world.add(new Enemy("zombie", path + "enemy.swf"), true, 620, -380);
			world.add(new Enemy("zombie", path + "enemy.swf"), true, 920, -380);
			...
			world.add(new Weapon("flame_gun", path + "flame_gun.png", -20, -10), false, 1800, 180);
